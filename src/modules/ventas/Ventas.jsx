...
// Módulo ventas — andamiaje listo para desarrollar.
...
export default function Ventas() {
  return (
    <div>
      <PageHeader titulo="Ventas" sub="Módulo pendiente de desarrollo" />
      <div className="card">
        <Empty>
          Este módulo tiene el andamiaje listo.<br />
          Desarrollalo en <b>src/modules/ventas/</b> siguiendo el ejemplo de Clientes y Comercial.
        </Empty>
      </div>
    </div>
  );
