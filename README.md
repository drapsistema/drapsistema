...
| Módulo         | Estado                                             |
|----------------|----------------------------------------------------|
| Login/Auth     | Completo (Supabase Auth, login obligatorio en prod) |
| Clientes       | Completo (listar, crear, editar, ficha con tabs)   |
| Comercial      | Completo (Kanban/Lista, drag&drop, click abre detalle) |
| Dashboard      | Completo (12 KPIs reales clickeables)              |
| Ventas         | Completo (listado, detalle, entrega, cancelación)  |
| Postventa      | Completo (visitas, semáforo, tareas)               |
| Service        | Completo (trabajos, tareas, repuestos, informe)    |
| Configuración  | Completo (usuarios, blanqueo, bloqueo, parámetros) |
